    ...
    <div class="topbar d-flex align-items-center">
      <div class="container d-flex justify-content-center justify-content-md-between">
        <div class="contact-info d-flex align-items-center">
          <i class="bi bi-envelope d-flex align-items-center"><a href="mailto:contact@example.com">minagslk@gmail.com</a></i>
          <i class="bi bi-phone d-flex align-items-center ms-4"><span>+60 12 341 0788</span></i>
        </div>
        <div class="social-links d-none d-md-flex align-items-center">
          <a href="#" class="twitter"><i class="bi bi-twitter-x"></i></a>
          <a href="https://www.facebook.com/ngan.pe.3994" class="facebook"><i class="bi bi-facebook"></i></a>
    ...
    <div class="branding d-flex align-items-cente">
      ...
      <div class="container position-relative d-flex align-items-center justify-content-between">
        <a href="/" class="logo d-flex align-items-center">
          ...
          <h1 class="sitename">Mina Land</h1>
        </a>
  ...
  <main class="main">
      ...
      <div class="container">
        <div class="row gy-4">
          <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center" data-aos="zoom-out">
            <h1>Welcome to <span>Mina Land</span></h1>
    ...
    <section id="about" class="about section light-background">
      ...
      <div class="container section-title" data-aos="fade-up">
        <h2>About</h2>
        <p><span>Find Out More</span> <span class="description-title">About Mina Land</span></p>
      ...
      <div class="container">
        <div class="row gy-3">
            <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="100">
                <div class="portfolio-inner" bis_skin_checked="1">
                    <div class="portfolio-post-thumbnail" bis_skin_checked="1">
                    <img src="{{asset('img/masonry-portfolio/masonry-portfolio-5.jpg')}}" class="img-fluid" alt="">
                        <div class="portfolio-content" bis_skin_checked="1">
                            <div class="portfolio-content-inner" bis_skin_checked="1">
                                <h4 class="entry-title"><a href="https://www.ethansee.com/portfolio/agile-embassy-garden">Agile Embassy Garden</a></h4>
                                <div class="entry-locations" bis_skin_checked="1">KLCC</div>
                                <ul class="portfolio-list">
                                        <li><label>Status </label><p>Under Construction</p></li>                        
                                        <li><label>Area </label><p>554 sqft - 1005 sqft</p></li>                        
                                        <li><label>Type </label><p>Serviced Residence</p></li>                    
                                    </ul>
                            </div>
                        </div>
                    </div>
